...
// const c =  data.flatMap(a=>a.map(n=>n*2))
// const v = data.flatMap(a=> a);
// const g = v.map(n=>n*2)
// console.log(v)
// console.log(g)
// console.log(c)
...
// const g = arr.reduce((a,b)=>a+b)
// const averge = g/arr.length
// console.log(g)
// console.log(averge)

// Use some and every to check if all > 15 and at least one > 45.

// const arr = [10, 20, 30, 40, 50,60];
// const checkgreterthan15 = arr.every(n=> n>15)
// const onegreater45 = arr.some(a=>a>45)
// console.log(checkgreterthan15);
// console.log(onegreater45);

// const nums = [1, 2, 3, 4, 5, 6, 7];

// function splitby3(arr,size){
// let pushvalues=[];
//     for(let i=0;i<arr.length; i+=3){
//         pushvalues.push(arr.slice(i,i+size));
//     }
//     return pushvalues;
// }
// const g = splitby3(nums, 3)
// console.log(g)
...
// const intersection = b.filter(b => a.includes(b))
// console.log(intersection)

// union
// const union = [...new Set([...a,...b])]
// console.log(union) // ...a,...b jor daita dono arrays ko set unique krta ha values ko  new sy pehly ... krta phir sy bna dait aha [] ky anadar arry ako

// // Symmetric Difference
// const symmtric = [...a.filter(a=> !b.includes(a)),
//     ...b.filter(b=> !a.includes(b))]
// console.log(symmtric)
...
// Flatten it
// const flatit = matrix.flatMap(a=>a)
// console.log(flatit)


//  Get diagonal elements.  1,5,9
// const diagonal = matrix.map((a,b)=> a[b]); // a aka matlab ha current row and b ka matlab ha current index
...
// const result = scores.reduce((a, s) => { // a ma values store hoti han or s ma values ati han array sy jo de gaii ho
//   if (s >= 85) {
//     a.push(s);
// }
//   return a;
...
//   }
//   return a;
// },[]) // [] ko a ky equal kr daita ha or a ma sari vaues puch hotii ha reduce ma
// console.log(result);
...
// Deep freeze an object (prevent any mutation).
...
// };
// Object.freeze(user);
// user.name = "husnain";// ya change nahi ho ga kun ky ya freeze ha
// user.address.city = "multan"; // ya freeze nahi kun ky ya direcly user nahi ha y asub part ha to ya chnage ho jaye ga
// console.log(user);
...
// deepfreeze(user)
// user.name = "husnain"
// user.address.city = "multan"
// user.address.country = "usa"
// console.log(user)


// const inventory = { apple: 10, banana: 5, orange: 8, kela: 3 };

// Increase every quantity by 2.
// const increase = Object.entries(inventory)
// console.log(increase)

// for(let key in inventory){
//   console.log(key,inventory[key]*2)
// }

// const increased = Object.fromEntries(
//   Object.entries(inventory).map(([key,vales])=>{
//     return [key, vales*2];
//   })
// )
...
// myCache.set("name", "Ali");
// myCache.set("age", 25);
// console.log(myCache.get("name")); // Ali
// console.log(myCache.get("age"));  // 25
...
//   deposit(amount){
//     if(amount<=0){
//       console.log("Invalid amount deposit")
//     }else{
//       this.balance +=amount;
//       console.log(`you deposited ${this.balance}`)
//     }
//   }
//   withdraw(amount){
//     if(amount<=0){
//       console.log("balance is of withdarwl is invalid")
//     }
//     if(amount>this.balance){
//       console.log("insufficent balanec ", this.balance)
//       return;
//     }
//       this.balance -= amount;
//       console.log(`your withdrawal is ${amount} & remaining balance ${this.balance}`)
...
//   }
// }
// const bnk = new BankAccount("pk-12345","husnian nawaz",1000);
// bnk.withdraw(10000);
// bnk.deposit(86);
// bnk.withdraw(1000);
// bnk.checkBalance()
...
//   }
//   getTotal(){
//     return this.marks.reduce((sum,valeusofarray) => sum+valeusofarray,0);
//   }
//   getPercentage(){
...
//   }
// }
// const student1 = new Student("Husnain",[54,33,66,73,91])
// const student2 = new Student("Ali",[14,33,46,63,86])
// const student3 = new Student("Musa",[64,37,76,39,87])
// student1.getResult()
